...
export default function Footer() {
  return (
    <section class="py-12  ">
      <div class="md:w-full h-px mt-8 mb-8  bg-gray-50/20 w-0 "></div>
        ...
        <div class="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
          <div class="xl:flex xl:items-center xl:justify-start">
            {/* <img
              ...
              alt=""
            /> */}
            <h2 className="text-2xl underline underline-offset-8 decoration-cyan-500">
          <span className="text-black bg-white font-semibold text-3xl rounded-lg px-2 mr-[4px] ">
            𝕾
          </span>
          Sharun Das
        </h2>
